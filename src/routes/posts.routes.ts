...
import { FindAllPostsByAuthorController } from "../modules/dashboard/posts/FindAllPostsByAuthor/FindAllPostsByAuthorController";
...
const findAllPostsByAuthorController = new FindAllPostsByAuthorController();
...
findAllPostsByAuthorController.handle);
